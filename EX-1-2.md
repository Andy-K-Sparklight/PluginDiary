...
![SERVER](https://i.loli.net/2021/02/03/Sz3mdTDUOeIPnVu.png)
...
![SUCCESS](https://i.loli.net/2021/02/03/LRTrYB3W6uxqkEH.png)

看上去很正常，我们再来多测试几次。

退出后重进：

![LOGIN](https://i.loli.net/2021/02/03/WltmLIAyrN75Db1.png)

很正常，那如果我们再输一次：

![AGAIN](https://i.loli.net/2021/02/03/PSLAzdvDJ7F38np.png)

很不错，那输错密码呢？

![WRONGPWD](https://i.loli.net/2021/02/03/2AigqbC3xmGd8zf.png)
...
- **这个插件仍有改进空间**，玩家进入服务器时没有提示信息，明文存储密码，每次修改都要保存，性能太差，并且没法更改密码，这都是问题。你可以想想解决这些问题的方法，我们将在「HarmonyAuth SMART」中解决这些问题。
...
<iframe frameborder="no" border="0" marginwidth="0" marginheight="0" width=330 height=86 src="//music.163.com/outchain/player?type=2&id=430297477&auto=0&height=66"></iframe>
